...
#define GPS_rxPin PB6
#define GPS_txPin PB7
...
String displayInfo() {
  ...
  if (gps.location.isValid()) {
    ...
    str = str + "Location: " + String(int(gps.location.lat())) + String(int(gps.location.lng()));
  } else {
  ...
  if (gps.date.isValid()) {
    ...
    str = str + "  Date/Time: " + String(gps.date.month()) + "/" + String(gps.date.day()) + "/" + String(gps.date.year());
  } else {
    Print_tx_rx.print(F("INVALID"));
  }
